...
const Hero = () =>  (
    ...
    <p className = {`${styles.paragraph} max-w-[470px] mt-5`}>
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, distinctio animi! Qui voluptatum optio nobis, accusamus laboriosam similique vitae expedita dolorem nisi? Enim nostrum doloribus, cupiditate tempore nisi suscipit. Necessitatibus.
    </p>
</div>
